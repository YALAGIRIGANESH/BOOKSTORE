...
<tr>
<td>Email</td>
<td><input type="email" name="email" value="${MyUserInfo.email}" /></td>
</tr>
<tr>
<td>Phone</td>
<td><input type="tel" name="phone" value="${MyUserInfo.phone}" /></td>
</tr>
<tr>
<td>Date of Birth</td>
<td><input type="date" name="dob" value="${MyUserInfo.dob}" readonly="readonly" /></td>
</tr>
<tr> <td>Gender</td>
